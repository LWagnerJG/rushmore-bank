...
3. **Draft** — snake draft four answers right away (35s pick clock; host can pause / +15s). Type your own; park picks in your **Stash** while waiting. Board stays on screen. **Lock in** on your turn (tap a stashed pick to lock instantly).
