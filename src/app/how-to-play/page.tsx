...
export default function HowToPlayPage() {
  return <main className="mx-auto max-w-md space-y-6 px-5 py-8">
    ...
    <p>One friend makes a room. Everyone else joins with the link, QR code, or room code. Bring 3–10 people and one phone each.</p>
    <ol className="space-y-3">
      ...
      <li className="panel"><strong>3. Earn beans.</strong><p className="mt-1 text-sm">Vote for someone else&apos;s best four. Everyone gets 20 beans, plus up to 40 from the AI judge and 5 per room vote.</p></li>
